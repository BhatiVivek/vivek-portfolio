...
const categoryIcons: Record<string, React.ReactNode> = {
  ...
  'Analytics': (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a10 10 0 1 0 10 10H12V2z" /><path d="M12 12 2.1 12a10.1 10.1 0 0 0 13.8 5.7" /></svg>
  ),
  'Cloud Platforms': (
  ...
  'Version Control': (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="18" cy="18" r="3" /><circle cx="6" cy="6" r="3" /><path d="M13 6h3a2 2 0 0 1 2 2v7" /><line x1="6" y1="9" x2="6" y2="21" /></svg>
  ),
};
    ...
    <section id="stack" className="container section-spacer">
      ...
      <div className={styles.stackGrid}>
        {Object.entries(skillsData).map(([category, skills], index) => (
          <div
            key={category}
            className={`spotlight-card ${styles.stackCard} fade-up`}
