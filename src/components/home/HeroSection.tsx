      ...
      <div className={`${styles.heroLayout} fade-up`}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroContactRow}>
            ...
            <span style={{ color: 'var(--text-tertiary)', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div className={styles.heroSocialRow}>
            <a href="https://github.com/bhativivek" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="GitHub">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#181717"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12z"/></svg>
            </a>
            <a href="https://www.linkedin.com/in/vivek-bhati-94324063/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="LinkedIn">
            ...
            <a href="https://medium.com/@vivekbhati9192" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} title="Medium">
              <svg width="20" height="20" viewBox="0 0 640 640" fill="#000000"><path d="M180.5 74.262C80.813 74.262 0 155.633 0 256s80.819 181.738 180.5 181.738S361 356.373 361 256 280.181 74.262 180.5 74.262zm288.25 10.652c-49.845 0-90.245 76.619-90.245 171.095s40.406 171.095 90.245 171.095 90.251-76.619 90.251-171.095-40.412-171.095-90.251-171.095zm139.506 18.262c-17.526 0-31.735 68.448-31.735 152.835s14.21 152.835 31.735 152.835S640 340.631 640 256.249 625.785 103.176 608.256 103.176z"/></svg>
            </a>
          </div>
        </div>
